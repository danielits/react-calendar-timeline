...
> {
  ...
  private get itemDivTitle();
  private get itemTimeStart();
  private get itemTimeEnd();
  private itemRef;
  private dragLeft?;
  private dragRight?;
  ...
  private getOrCreateResizeOverlay;
  private updateResizeLabel;
  ...
  getItemProps: ({
    ...
    title: string;
    className: string;
    onMouseDown: (event: MouseEvent<HTMLDivElement, globalThis.MouseEvent>, ...args: unknown[]) => void;
    onMouseUp: (event: MouseEvent<HTMLDivElement, globalThis.MouseEvent>, ...args: unknown[]) => void;
    onTouchStart: (event: TouchEvent<HTMLDivElement>, ...args: unknown[]) => void;
    onTouchEnd: (event: TouchEvent<HTMLDivElement>, ...args: unknown[]) => void;
    onDoubleClick: (event: MouseEvent<HTMLDivElement, globalThis.MouseEvent>, ...args: unknown[]) => void;
    onContextMenu: (event: MouseEvent<HTMLDivElement, globalThis.MouseEvent>, ...args: unknown[]) => void;
    style: any;
