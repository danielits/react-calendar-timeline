 ...
 * @returns {number}
 */
export declare function coordinateToTimeRatio(
 ...
 * @returns {number}
 */
export declare function calculateXPositionForTime(
  canvasTimeStart: number,
  canvasTimeEnd: number,
  canvasWidth: number,
  time: number
 ...
 * @returns {number}
 */
export declare function calculateTimeForXPosition(
  canvasTimeStart: number,
  canvasTimeEnd: number,
  canvasWidth: number,
  leftOffset: number
): number;
export declare function iterateTimes(
  start: number,
  end: number,
...
export declare function getMinUnit(
  zoom: number,
  width: number,
  timeSteps: TimelineTimeSteps,
  useWeeks?: boolean
...
export declare const NEXT_UNITS_WEEKS: Record<SelectUnits, SelectUnitsRes>;
export declare const NEXT_UNITS_MONTHS: Record<SelectUnits, SelectUnitsRes>;
/** @deprecated use NEXT_UNITS_WEEKS or NEXT_UNITS_MONTHS */
export declare const NEXT_UNITS: Record<SelectUnits, SelectUnitsRes>;
export declare function getNextUnit(unit: SelectUnits, useWeeks?: boolean): SelectUnitsRes;
/**
 ...
 */
export declare function calculateInteractionNewTimes({
  itemTimeStart,
  itemTimeEnd,
  dragTime,
  isDragging,
...
export declare function getVisibleItems<CustomItem extends TimelineItemBase<any> = TimelineItemBase<number>>(
  items: CustomItem[],
  canvasTimeStart: number,
  canvasTimeEnd: number,
  keys: TimelineKeys
): CustomItem[];
export declare function collision(
  a: Dimension,
  b: Dimension,
 ...
 * is being stacked
 */
export declare function groupStack(
  lineHeight: number,
  item: ItemDimension,
  group: ItemDimension[],
  groupHeight: number,
...
export declare function groupNoStack(
  lineHeight: number,
  item: ItemDimension,
  groupHeight: number,
  groupTop: number,
 ...
 */
export declare function stackAll(
 ...
 */
export declare function stackTimelineItems<
 ...
 */
export declare function getItemDimensions<CustomItem extends TimelineItemBase<any>>({
  item,
  keys,
  canvasTimeStart,
  canvasTimeEnd,
 ...
 * @param {*} newGroupOrder
 */
export declare function getItemWithInteractions<
 ...
 * @param buffer
 */
export declare function getCanvasBoundariesFromVisibleTime(
 ...
 * @param {*} state
 */
export declare function calculateScrollCanvas<
