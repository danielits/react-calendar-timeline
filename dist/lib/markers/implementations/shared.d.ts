...
export declare const createMarkerStylesWithLeftOffset: (leftOffset: number) => {
  left: number;
...
export declare const createDefaultRenderer: (
  dataTestidValue: string | undefined
) => ({ styles }: { styles: React.CSSProperties }) => import("react/jsx-runtime").JSX.Element;
