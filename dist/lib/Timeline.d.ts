...
export interface ReactCalendarTimelineRef {
  ...
  calculateDropCoordinatesToTimeAndGroup(
    x: number,
    y: number
  ): {
    time: number;
...
> {
  ...
  getEffectiveSidebarWidth(props?: Readonly<ReactCalendarTimelineProps<CustomItem, CustomGroup>>): number;
  ...
  componentDidUpdate(
    _: ReactCalendarTimelineProps<CustomItem, CustomGroup>,
    prevState: ReactCalendarTimelineState
  ): void;
  resize: (props?: Readonly<ReactCalendarTimelineProps<CustomItem, CustomGroup>>, containerWidth?: number) => void;
  ...
  rows(
    canvasWidth: number,
    groupHeights: number[],
    groups: typeof this.props.groups
  ): import("react/jsx-runtime").JSX.Element;
  items({
    canvasTimeStart,
    canvasTimeEnd,
  ...
  sidebar(height: number, groupHeights: number[]): false | import("react/jsx-runtime").JSX.Element;
